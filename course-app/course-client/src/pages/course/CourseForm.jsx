  ...
  return (
    <Form method={method}>
      ...
      <div>
        ...
        />
        {result && result.title && <p className="err">{result.title}</p>}
      </div>
      <div>
        ...
        />
        {result && result.image && <p className="err">{result.image}</p>}
      </div>
      <div>
        ...
        {result && result.description && (
          <p className="err">{result.description}</p>
        )}
      </div>
